...
A documentação deixou de ser um pré-requisito e passou a ser contextual. Isso reduziu a carga cognitiva sem esconder a complexidade real do sistema. A ### Documentação — Português (PT-BR)
...
A documentação deixou de ser um pré-requisito e passou a ser contextual. Isso reduziu a carga cognitiva sem esconder a complexidade real do sistema. A mudança se refletiu em:
