...
1. **Pedir información sin haber entregado valor**
   Formularios largos, configuraciones obligatorias o decisiones irreversibles al inicio generan resistencia. La razón: el usuario aún no confía en el sistema.

2. **Interrumpir el flujo con decisiones mal contextualizadas**
   Pantallas que preguntan “¿Cómo planeas usar X?” o “Elige tu plan” antes de que el usuario entienda X rompen el ritmo y le imponen al usuario una carga que aún no puede asumir.
